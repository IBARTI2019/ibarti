<script type="text/javascript">
  $("#add_precliente_form").on('submit', function(evt) {
    evt.preventDefault();
    save_precliente();

  });

  $("#add_precliente_form input, select").change(function(evt) {
    evt.preventDefault();
    $("#c_cambios").val('true');
    $('#salvar_precliente').attr('disabled', false);
  });
...
<form action="" method="post" id="add_precliente_form">
  <fieldset class="fieldset">
    <legend>Datos <?php echo $leng['precliente']; ?></legend>
    <table width="100%" align="center">
      ...
      <tr>
        ...
        <td class="etiqueta">Tipo <?php echo $leng['precliente']; ?>: </td>
    ...
    <div align="center">
      <span class="art-button-wrapper">
        ...
        <input type="submit" name="salvar" id="salvar_precliente" value="Guardar" class="readon art-button" />
      </span>&nbsp;
      <?php if ($metodo == 'modificar') { ?>
        <span class="art-button-wrapper">
          <span class="art-button-l"> </span>
