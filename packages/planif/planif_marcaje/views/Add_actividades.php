...
foreach ($result as  $datos) {
    ...
    if ($datos["realizado"] == 'SI') {
        ...
        echo '<td><img class="imgLink" id="m_observaciones" src="imagenes/nuevo.bmp" alt="Modificar Observaciones" title="Modificar Observaciones" onclick="openModalObservacionesdos(' . $datos["codigo"] . ',\'' .$ficha . '\',\''. $cliente .'\','. $ubicacion .',\''. $datos["cod_proyecto"] .'\')" width="15px" height="15px"></td>
