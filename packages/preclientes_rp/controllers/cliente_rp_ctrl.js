...
function Cons_upm_inicio(callback) {
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Cons_inicio.php',
		type:  'post',
...
function llenar_cliente(region){
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Get_cliente.php',
		type:  'post',
		success:  function (response) {
...
function llenar_region(){
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Get_region.php',
		type:  'post',
		success:  function (response) {
...
function llenar_estado(){
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Get_estados.php',
		type:  'post',
		success:  function (response) {
...
function llenar_ciudad(estado){
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Get_ciudades.php',
		type:  'post',
		success:  function (response) {
...
function llenar_puesto(cliente,ubicacion){
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Get_puesto.php',
		type:  'post',
		success:  function (response) {
...
function llenar_estatu(){
	...
	$.ajax({
		data:  parametros,
		url:   'packages/preclientes_rp/views/Get_estatus.php',
		type:  'post',
		success:  function (response) {
...
function llenar_ubicacion(cliente){
   ...
   if(cliente!='TODOS'){
   	$.ajax({
   		data:  parametros,
   		url:   'packages/preclientes_rp/views/Get_ubicacion.php',
   		type:  'post',
   		success:  function (response) {
