	...
	<fieldset class="fieldset">
		...
		<table width="90%" align="center">
			...
			<tr>
				...
				<td id="input03"><input type="text" id="ub_contacto" maxlength="30" size="30" value="<?php echo $ubic["contacto"]; ?>" /><br />
					<span class="textfieldRequiredMsg">El Campo es Requerido...</span>
				</td>

				<td class="etiqueta">Cargo :</td>
				<td id="input04"><input type="text" id="ub_cargo" maxlength="30" size="30" value="<?php echo $ubic["cargo"]; ?>" />
				</td>
			</tr>
			<tr>
