...
class Ubicacion
{
	...
	public function editar($cod)
	{
		...
		$sql = " SELECT clientes_ubicacion.codigo,
	                  ...
	                  clientes_ubicacion.descripcion, clientes_ubicacion.direccion,
	                  clientes_ubicacion.contacto,clientes_ubicacion.contacto1,clientes_ubicacion.contacto2,clientes_ubicacion.contacto3,clientes_ubicacion.latitud,clientes_ubicacion.longitud, 
					  clientes_ubicacion.direccion_google, clientes_ubicacion.cargo,
					  clientes_ubicacion.cargo1,clientes_ubicacion.cargo2,clientes_ubicacion.cargo3,clientes_ubicacion.telefono,clientes_ubicacion.telefono1,
	                  clientes_ubicacion.telefono2,clientes_ubicacion.telefono3,clientes_ubicacion.email, clientes_ubicacion.email1,clientes_ubicacion.email2,clientes_ubicacion.email3, clientes_ubicacion.observacion,
						        clientes_ubicacion.campo01, clientes_ubicacion.campo02,
						        clientes_ubicacion.campo03, clientes_ubicacion.campo04,
						        clientes_ubicacion.`status`,
						(
