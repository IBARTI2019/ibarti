...
/* SIN PUESTO */
function rp_planif_trab_servresumida(data, id_contenedor, callback, formato) {
	if (d3.select('#' + id_contenedor).node()) {
		...
		rp_planif_trab_serv_create_cabeceraresumida(id_contenedor, callback, formato);
	}
}



function rp_planif_trab_serv_create_cabeceraresumida(id_contenedor, callback, formato) {
	...
	rp_planif_trab_serv_contratoresumida(tablas);
	
	
}
function rp_planif_trab_serv_contratoresumida(tablas, callback) {
	...
	rp_planif_trab_serv_trabajadorresumida(tablas);
}

function rp_planif_trab_serv_trabajadorresumida(tablas, callback) {
	...
	rp_planif_trab_serv_diferenciaresumida(tablas);
}
...
function rp_planif_trab_serv_diferenciaresumida(tablas, callback) {
