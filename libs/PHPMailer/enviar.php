...
function enviar_mail_htmlmasivos($host,$puerto,$smtpSecure,$cuentaDeEnvio,$passwordCuentaDeEnvio,$nombre,$tema,$cuerpo,$cuerpoHtml,$cuentaDestinos) {
	$mail = new PHPMailer() ;
...
//Sustituye (ServidorDeCorreoSMTP)  por el host de tu servidor de correo SMTP
	...
	$mail->AltBody  = $cuerpo; 
	$mail->MsgHTML($cuerpoHtml);
	foreach ($cuentaDestinos as $destinatario) {
