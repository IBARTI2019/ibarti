...
if ($metodo=="buscar"){
    ...
    $query="SELECT count(*) as filas FROM productos,prod_ean WHERE productos.item=prod_ean.cod_producto AND prod_ean.cod_producto ='$producto' AND prod_ean.cod_ean NOT IN (SELECT cod_ean FROM v_stock_asignado_eans WHERE v_stock_asignado_eans.cod_producto = '$producto') AND ".$where;
    $sql="SELECT prod_ean.cod_producto as codigo,prod_ean.cod_ean as eans FROM prod_ean WHERE prod_ean.cod_producto ='$producto' AND prod_ean.cod_ean NOT IN (SELECT cod_ean FROM v_stock_asignado_eans  WHERE v_stock_asignado_eans.cod_producto = '$producto') AND ".$where;
} 
