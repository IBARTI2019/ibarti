...
$bd = new DataBase();
$archivo = "reportes/rp_pl_supervisor_conteo_det.php?Nmenu=$Nmenu&mod=$mod";
$titulo  = " PLANIFICACIÓN DE PERSONAL DETALLADO";
...
<script language="JavaScript" type="text/javascript">
	...
	function Add_filtroX() { // CARGAR  ARCHIVO DE AJAX CON UN PARAMETRO //
		...
		if (error == 0) {
			...
			$.ajax({
				data: parametros,
				url: 'ajax_rp/Add_pl_supervisor_conteo.php',
				type: 'post',
				beforeSend: function() {
