...
AND prod_dotacion_det.cod_dotacion IN (SELECT pdd.cod_dotacion FROM prod_dotacion pd, prod_dotacion_det pdd WHERE pd.codigo = pdd.cod_dotacion AND pd.cod_ficha = ficha.cod_ficha GROUP BY pdd.cod_sub_linea)
